    ...
    MetaData: [
      {
        MetaDataItem: [
          {
            text: "http://www.openzwave.com/device-database/0086:0064:0102",
            name: "OzwInfoPage",
          },
          { text: "images/aeotec/zw100.png", name: "ProductPic" },
          {
            text: "https://products.z-wavealliance.org/products/2684/",
            id: "0064",
            name: "ZWProductPage",
            type: "0102",
          },
          ...
          { text: "ZW100-A", id: "0064", name: "Identifier", type: "0102" },
          { text: "MultiSensor 6", name: "Name" },
          {
            text:
          ...
          {
            text:
              "Aeotec MultiSensor 6 looks like a motion sensor and it acts like one too. But it’s also so much more. Installing this 1 piece of Z-Wave® technology is the same as installing 6 pieces of Z-Wave technology. Your home control network will immediately understand motion, temperature, humidity, light, Ultraviolet and Vibration readings wherever MultiSensor installed. Those intelligent readings will equate to intelligence automation. And intelligent automation will give you the perfect, smart home.",
            name: "Description",
          },
          {
            text:
          ...
          {
            text:
              "https://Products.Z-WaveAlliance.org/ProductManual/File?folder=&filename=Manuals/2714/Aeon Labs MultiSensor 6 manual.pdf",
            name: "ProductManual",
          },
          {
            text: "https://products.z-wavealliance.org/products/2714/",
            id: "0064",
            name: "ZWProductPage",
            type: "0002",
          },
          { text: "ZW100-C", id: "0064", name: "Identifier", type: "0002" },
          {
            text: "CEPT (Europe)",
            id: "0064",
            name: "FrequencyName",
          ...
          {
            text: "https://products.z-wavealliance.org/products/2695/",
            id: "0064",
            name: "ZWProductPage",
            type: "0202",
          },
          { text: "ZW100-B", id: "0064", name: "Identifier", type: "0202" },
          {
        ...
        ChangeLog: [
          {
            Entry: [
              {
                text:
                  "Initial Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/1390/xml",
              ...
              {
                text:
                  "Updated Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/1403/xml",
                author: "Justin Hammond - Justin@dynam.ac",
                date: "08 May 2019",
                revision: 18,
              },
              {
                text:
                  "Updated Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/1404/xml",
                author: "Justin Hammond - Justin@dynam.ac",
                date: "08 May 2019",
                revision: 19,
              },
              {
                text:
                  "Updated Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/1810/xml",
                author: "Justin Hammond - Justin@dynam.ac",
                date: "24 May 2019",
                revision: 20,
              },
              {
                text:
                  "Updated Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/1812/xml",
                author: "Justin Hammond - Justin@dynam.ac",
                date: "24 May 2019",
                revision: 21,
              },
              {
                text:
                  "Updated Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/2684/xml",
                author: "Justin Hammond - Justin@dynam.ac",
                date: "02 Jun 2019",
                revision: 22,
              },
              {
                text:
                  "Updated Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/2695/xml",
                author: "Justin Hammond - Justin@dynam.ac",
                date: "02 Jun 2019",
                revision: 23,
              },
              {
                text:
                  "Updated Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/2714/xml",
                author: "Justin Hammond - Justin@dynam.ac",
                date: "02 Jun 2019",
                revision: 24,
              },
        ...
        Value: [
          {
            ...
            Item: [
              ...
              { label: "Disable-fr", lang: "fr", value: "0" },
              { label: "Enable-Fr", lang: "fr", value: "1" },
            ],
          },
          {
            genre: "config",
          ...
          },
          {
            ...
            Help: [
              ...
              { text: "French Help", lang: "fr" },
            ],
            Label: [
              {
                text: "Enable/disable to send a report on Threshold-fr",
                lang: "fr",
              },
            ],
            BitSet: [
              {
                ...
                Label: [
                  "Lower Temperature",
                  { text: "Lower Temperature-fr", lang: "fr" },
                ],
                Help: [
                  "Lower Temperature Threshold",
                  { text: "Lower Temperature Threshold-fr", lang: "fr" },
                ],
              },
              {
                id: "2",
                Label: [
                  "Lower Humidity",
                  { text: "Lower Humidity-fr", lang: "fr" },
                ],
                Help: [
                  "Lower Humdity Threshold",
                  { text: "Lower Humdity Threshold-fr", lang: "fr" },
                ],
              },
              {
                id: "3",
                Label: [
                  "Lower Luminance",
                  { text: "Lower Luminance-fr", lang: "fr" },
                ],
                Help: [
                  "Lower Luminance Threshold",
                  { text: "Lower Luminance Threshold", lang: "fr" },
                ],
              },
              {
                id: "4",
                Label: [
                  "Lower Ultraviolet",
                  { text: "Lower Ultraviolet-fr", lang: "fr" },
                ],
                Help: [
                  "Lower Ultraviolet Threshold",
                  { text: "Lower Ultraviolet Threshold-fr", lang: "fr" },
                ],
              },
              {
                id: "5",
                Label: [
                  "Upper Temperature",
                  { text: "Upper Temperature-fr", lang: "fr" },
                ],
                Help: [
                  "Upper Temerature Threshold",
                  { text: "Upper Temerature Threshold-fr", lang: "fr" },
                ],
              },
              {
                id: "6",
                Label: [
                  "Upper Humidity",
                  { text: "Upper Humidity-fr", lang: "fr" },
                ],
                Help: [
                  "Upper Humdity Threshold",
                  { text: "Upper Humdity Threshold-fr", lang: "fr" },
                ],
              },
              {
                id: "7",
                Label: [
                  "Upper Luminance",
                  { text: "Upper Luminance-fr", lang: "fr" },
                ],
                Help: [
                  "Upper Luminance Threshold",
                  { text: "Upper Luminance Threshold-fr", lang: "fr" },
                ],
              },
              {
                id: "8",
                Label: [
                  "Upper Ultraviolet",
                  { text: "Upper Ultraviolet-fr", lang: "fr" },
                ],
                Help: [
                  "Upper Ultraviolet Threshold",
                  { text: "Upper Ultraviolet Threshold-fr", lang: "fr" },
                ],
              },
            ],
          },
          ...
          },
          {
            ...
            BitSet: [
              { id: "1", Label: "Battery", Help: "Send Battery Report" },
              {
                id: "5",
                Label: "Ultraviolet",
              ...
              },
              {
                id: "6",
                Label: "Temperature",
                Help: "Send Temperature Report",
              },
              { id: "7", Label: "Humidity", Help: "Send Humidity Report" },
              { id: "8", Label: "Luminance", Help: "Send Luminance Report" },
            ],
          },
          {
            genre: "config",
