    ...
    MetaData: [
      {
        MetaDataItem: [
          {
            text: "http://www.openzwave.com/device-database/0086:0070:0102",
            name: "OzwInfoPage",
          },
          { text: "images/aeotec/zw112.png", name: "ProductPic" },
          {
            text: "https://products.z-wavealliance.org/products/1611/",
            id: "0070",
            name: "ZWProductPage",
            type: "0102",
          },
          {
            text:
              "https://Products.Z-WaveAlliance.org/ProductManual/File?folder=&filename=Manuals/1616/Door Window Sensor 6 manual.pdf",
            name: "ProductManual",
          },
          {
            text:
          ...
          { text: "ZW112-A", id: "0070", name: "Identifier", type: "0102" },
          {
            text: "https://products.z-wavealliance.org/products/1615/",
            id: "0070",
            name: "ZWProductPage",
            type: "0002",
          },
          ...
          { text: "ZW112-C", id: "0070", name: "Identifier", type: "0002" },
          {
            text: "https://products.z-wavealliance.org/products/1616/",
            id: "0070",
            name: "ZWProductPage",
            type: "0202",
          },
          { text: "ZW112-B", id: "0070", name: "Identifier", type: "0202" },
          {
        ...
        ChangeLog: [
          {
            Entry: [
              {
                text:
                  "Initial Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/1611/xml",
              ...
              {
                text:
                  "Updated Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/1615/xml",
                author: "Justin Hammond - Justin@dynam.ac",
                date: "24 May 2019",
                revision: 5,
              },
              {
                text:
                  "Updated Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/1616/xml",
                author: "Justin Hammond - Justin@dynam.ac",
                date: "24 May 2019",
                revision: 6,
              },
