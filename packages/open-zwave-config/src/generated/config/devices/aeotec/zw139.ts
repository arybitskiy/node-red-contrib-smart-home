    ...
    MetaData: [
      {
        MetaDataItem: [
          {
            text: "http://www.openzwave.com/device-database/0086:008B:0103",
            name: "OzwInfoPage",
          },
          { text: "images/aeotec/zw139.png", name: "ProductPic" },
          {
            text: "https://products.z-wavealliance.org/products/2306/",
            id: "008B",
            name: "ZWProductPage",
            type: "0103",
          },
          ...
          {
            text:
              "https://Products.Z-WaveAlliance.org/ProductManual/File?folder=&filename=Manuals/2320/Nano Switch manual.pdf",
            name: "ProductManual",
          },
          { text: "ZW139-A", id: "008B", name: "Identifier", type: "0103" },
          {
          ...
          {
            text: "https://products.z-wavealliance.org/products/2319/",
            id: "008B",
            name: "ZWProductPage",
            type: "0203",
          },
          { text: "ZW139-B", id: "008B", name: "Identifier", type: "0203" },
          {
          ...
          {
            text: "https://products.z-wavealliance.org/products/2320/",
            id: "008B",
            name: "ZWProductPage",
            type: "0003",
          },
          { text: "ZW139-C", id: "008B", name: "Identifier", type: "0003" },
          {
            text: "CEPT (Europe)",
            id: "008B",
            name: "FrequencyName",
        ...
        ChangeLog: [
          {
            Entry: [
              {
                text:
                  "Initial Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/2306/xml",
              ...
              {
                text:
                  "Updated Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/2319/xml",
                author: "Justin Hammond - Justin@dynam.ac",
                date: "02 Jun 2019",
                revision: 4,
              },
              {
                text:
                  "Updated Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/2320/xml",
                author: "Justin Hammond - Justin@dynam.ac",
                date: "02 Jun 2019",
                revision: 5,
              },
    ...
    CommandClass: [
      {
        ...
        Value: [
          ...
          },
          {
            ...
            Item: [
              { label: "Unknown switch mode", value: "0" },
          ...
          },
          {
            genre: "config",
            index: "122",
            label: "Set the control destination of the external switch",
            max: "3",
            min: "0",
            size: "1",
            type: "list",
            ...
            Help: "",
            Item: [
              { label: "Control itself", value: "1" },
              { label: "Control other nodes in the same network", value: "2" },
              {
                label: "Control itself and other nodes in the same network",
                value: "3",
              },
            ],
          },
