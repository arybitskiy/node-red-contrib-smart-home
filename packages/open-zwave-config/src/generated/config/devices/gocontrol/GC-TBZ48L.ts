      ...
      },
      {
        ...
        Value: [
          ...
          },
          {
            ...
            Help: "\n        Mechanical Status\n      ",
            Item: [
              { label: "MECH_H1", value: "1" },
              { label: "MECH_H2", value: "2" },
              { label: "MECH_H3", value: "4" },
              { label: "MECH_C1", value: "8" },
              { label: "MECH_C2", value: "16" },
              { label: "PHANTOM_F", value: "32" },
              { label: "MECH_F", value: "64" },
              { label: "MANUAL_F", value: "128" },
              { label: "reserved", value: "256" },
            ],
          },
          {
            genre: "config",
            ...
            Help: "\n        SCP Status\n      ",
            Item: [
              { label: "STATE_HEAT", value: "1" },
              { label: "STATE_COOL", value: "2" },
              { label: "STATE_2ND", value: "4" },
              { label: "STATE_3RD", value: "8" },
              { label: "STATE_FAN", value: "16" },
              { label: "STATE_LAST", value: "32" },
              { label: "STATE_MOT", value: "64" },
              { label: "STATE_MRT", value: "128" },
            ],
          },
          {
            genre: "config",
            index: "23",
            label: "Autosend Enable Bits",
            max: "32768",
            min: "1",
            size: "2",
            type: "list",
            ...
            Item: [
              ...
              { label: "Setpoint H", value: "2" },
              { label: "Setpoint C", value: "4" },
              { label: "Mode", value: "8" },
              { label: "Fan Mode", value: "16" },
              { label: "Fan State", value: "32" },
              { label: "Operating State", value: "64" },
              { label: "Schedule Enable", value: "128" },
              { label: "Setback", value: "256" },
              { label: "Runhold", value: "512" },
              { label: "Display Lock", value: "1024" },
              { label: "Battery", value: "8192" },
              { label: "Mechanical Status", value: "16384" },
              { label: "SCP Status", value: "32768" },
            ],
          },
          {
            genre: "config",
