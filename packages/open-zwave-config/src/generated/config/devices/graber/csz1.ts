    ...
    MetaData: [
      {
        MetaDataItem: [
          {
            text: "http://www.openzwave.com/device-database/026E:5A31:4353",
            name: "OzwInfoPage",
          },
          { text: "images/graber/csz1.png", name: "ProductPic" },
          {
            text: "https://products.z-wavealliance.org/products/1749/",
            id: "5A31",
            name: "ZWProductPage",
            type: "4353",
          },
          ...
          {
            text:
              "https://Products.Z-WaveAlliance.org/ProductManual/File?folder=&filename=Manuals/1749/Graber Virtual Cord Owner's Manual 0002.pdf",
            name: "ProductManual",
          },
          {
            text:
          ...
          { text: "Cellular Shade Radio Z-Wave", name: "Name" },
          {
            text:
              "1. Put Primary Controller into \nExclusion Mode\n\n2. Press and Hold Shade Programming Button for >2seconds",
            name: "ExclusionDescription",
          },
          { text: "CSZ1", id: "5A31", name: "Identifier", type: "4353" },
        ],
        ChangeLog: [
          {
            Entry: [
              {
                text:
                  "Initial Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/1749/xml",
