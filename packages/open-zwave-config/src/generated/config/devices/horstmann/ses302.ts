    ...
    MetaData: [
      {
        MetaDataItem: [
          {
            text: "http://www.openzwave.com/device-database/0059:0002:000D",
            name: "OzwInfoPage",
          },
          { text: "images/horstmann/ses302.png", name: "ProductPic" },
          {
            text: "https://products.z-wavealliance.org/products/1240/",
            id: "0002",
            name: "ZWProductPage",
            type: "000D",
          },
          ...
          {
            text:
              "https://Products.Z-WaveAlliance.org/ProductManual/File?folder=&filename=Manuals/1240/SES 302 and 303 TH Sensors User Installation Manual, (Secure Controls UK Ltd) BGX501-923-R02.pdf",
            name: "ProductManual",
          },
          { text: "SES 302", id: "0002", name: "Identifier", type: "000D" },
          {
            text:
          ...
          {
            text:
              "Step 1.On the Z-Wave controller, select exclusion for removing a device from the network. \nStep 2: On the SES 302, press the button, hold and release after 1 second to send a request (Network Information Frame) to remove from the network. On successful exclusion the LED will flash 2 times. The total process can take up to 2 seconds. If the LED flashes 4-times this means that the exclusion process has failed, so try moving the SES 302 to another position and repeat the exclusion steps. The controller will show when the exclusion operation is successful.",
        ...
        ChangeLog: [
          {
            Entry: [
              {
                text:
                  "Initial Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/1240/xml",
