    ...
    MetaData: [
      {
        MetaDataItem: [
          {
            text: "http://www.openzwave.com/device-database/0159:0052:0002",
            name: "OzwInfoPage",
          },
          { text: "images/qubino/ZMNHADx.png", name: "ProductPic" },
          {
            text: "https://products.z-wavealliance.org/products/2795/",
            id: "0052",
            name: "ZWProductPage",
            type: "0002",
          },
          { text: "ZMNHAD1", id: "0052", name: "Identifier", type: "0002" },
          {
            text:
          ...
          {
            text:
              "https://Products.Z-WaveAlliance.org/ProductManual/File?folder=&filename=Manuals/2795/Qubino_Flush 1 Relay PLUS extended manual_eng_2.2.pdf",
            name: "ProductManual",
          },
          { text: "Flush 1 Relay", name: "Name" },
          {
            text: "CEPT (Europe)",
            id: "0052",
            name: "FrequencyName",
          ...
          {
            text:
              "The Flush 1 Relay controls on/off function for one electrical device. It measures power consumption of the connected device, and can be paired with a digital temperature sensor (sold separately). It supports push-button/momentary switches and toggle switches (default).\n\nThe connection of a digital temperature sensor means you can create complex scenes and control any device relative to a set temperature range. The Qubino Flush 1 Relay also acts as a Z-Wave repeater to improve the range and stability of the Z-Wave network.",
            name: "Description",
          },
        ],
        ChangeLog: [
          {
            Entry: [
              {
                text:
                  "Initial Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/2795/xml",
              ...
              {
                text:
                  "Fix for 'module does not work on 1.6' - https://github.com/OpenZWave/open-zwave/issues/1820",
                author: "Peter Gebruers - peter.gebruers@gmail.com",
                date: "10 Jun 2019",
                revision: 7,
              },
              {
                text: "Add Instance Labels for i2, i3 and Temp Sensor Channels",
                author: "Justin Hammond - Justin@dynam.ac",
                date: "26 Jun 2019",
                revision: 8,
              },
              {
                text:
                  "Workaround for MCA assocation issue https://github.com/OpenZWave/open-zwave/issues/1895",
                author: "Peter Gebruers - peter.gebruers@gmail.com",
                date: "10 Jun 2019",
                revision: 9,
              },
