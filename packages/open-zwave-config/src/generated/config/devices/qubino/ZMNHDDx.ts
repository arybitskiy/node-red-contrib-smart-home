    ...
    MetaData: [
      {
        MetaDataItem: [
          {
            text: "http://www.openzwave.com/device-database/0159:0051:0001",
            name: "OzwInfoPage",
          },
          { text: "images/qubino/ZMNHDDx.png", name: "ProductPic" },
          {
            text: "https://products.z-wavealliance.org/products/2114/",
            id: "0051",
            name: "ZWProductPage",
            type: "0001",
          },
          ...
          {
            text:
              "https://Products.Z-WaveAlliance.org/ProductManual/File?folder=&filename=Manuals/2114/Qubino_Flush Dimmer PLUS extended manual_eng_2.3.pdf",
            name: "ProductManual",
          },
          {
          ...
          { text: "ZMNHDD2", id: "0051", name: "Identifier", type: "0001" },
          { text: "Qubino Flush Dimmer", name: "Name" },
          {
            text:
        ...
        ChangeLog: [
          {
            Entry: [
              {
                text:
                  "Initial Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/2077/xml",
              ...
              {
                text:
                  "Updated Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/2114/xml",
                author: "Justin Hammond - Justin@dynam.ac",
                date: "02 Jun 2019",
                revision: 7,
              },
              {
                text: "Tweak config label for consistency of both buttons",
                author: "Chris Nesbitt-Smith - chris@cns.me.uk",
                date: "27 Sep 2019",
                revision: 8,
              },
              {
                text:
                  "fixes: qubino wrong config parameter 68 in ZMNHDDX.xml #1995",
                author:
                  "Peter Gebruers - peter.gebruers@gmail.com on behalf of jtonk",
                date: "17 Nov 2019",
                revision: 9,
              },
            ],
