        ...
        Value: [
          ...
          },
          {
            ...
            Item: [
              ...
              { label: "No influence on the heat process", value: "32767" },
            ],
          },
          {
            genre: "config",
          ...
          },
          {
            ...
            value: "0",
            Help:
              "Set value means time interval (0 - 32767) in seconds, when power report is send. 0 - Reporting Disabled. 1 - 32767 = 1 second - 32767 seconds. Reporting enabled. Power report is send with time interval set by entered value. Default value 0",
          },
          {
            genre: "config",
            index: "45",
        ...
        Associations: [
          {
            ...
            Group: [
              ...
              },
              {
                index: "3",
                label:
                  "Basic on/off (triggered at change of thermostat mode) up to 16 nodes",
                max_associations: "16",
              },
              {
                index: "4",
              ...
              },
              {
                index: "5",
                label:
                  "Basic on/off (triggered by Too low temperature limit, it send FF) up to 16 nodes",
                max_associations: "16",
              },
              {
                index: "6",
