    ...
    MetaData: [
      {
        MetaDataItem: [
          {
            text: "http://www.openzwave.com/device-database/0115:0103:0100",
            name: "OzwInfoPage",
          },
          { text: "images/zwave.me/popp_kfob-c.png", name: "ProductPic" },
          {
            text: "https://products.z-wavealliance.org/products/1282/",
            id: "0103",
            name: "ZWProductPage",
            type: "0100",
          },
        ...
        ChangeLog: [
          {
            Entry: [
              {
                text:
                  "Initial Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/1282/xml",
