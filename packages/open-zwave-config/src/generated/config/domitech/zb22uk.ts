    ...
    MetaData: [
      {
        MetaDataItem: [
          {
            text: "http://www.openzwave.com/device-database/020E:3135:4C42",
            name: "OzwInfoPage",
          },
          { text: "images/domitech/zb22uk.png", name: "ProductPic" },
          {
            text: "https://products.z-wavealliance.org/products/1543/",
            id: "3135",
            name: "ZWProductPage",
            type: "4C42",
          },
          { text: "ZB22UK", id: "3135", name: "Identifier", type: "4C42" },
          {
            text:
              "https://Products.Z-WaveAlliance.org/ProductManual/File?folder=&filename=Manuals/1543/Instructions_ZB22UK_10222015 small.pdf",
            name: "ProductManual",
          },
          {
            text:
              "Smart LED light bulb with Z-Wave radio.\n- Control lights remotely and save energy\n- Compatible with smart home systems supporting Z-Wave\n- 60 Watt equivalent light (806 lumens)\n- Consumes only 9 watts of power\n- 2700K Day light with frosted glass \n- Instant ON and fully dimmable\n- Functions as a Z-Wave signal repeater\n- Very simple to include in your network\n- Z-Wave Plus certified",
            name: "Description",
          },
          {
            text:
        ...
        ChangeLog: [
          {
            Entry: [
              {
                text:
                  "Initial Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/1543/xml",
