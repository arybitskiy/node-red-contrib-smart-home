    ...
    MetaData: [
      {
        MetaDataItem: [
          {
            text: "http://www.openzwave.com/device-database/020E:3134:4C42",
            name: "OzwInfoPage",
          },
          { text: "images/domitech/ze27eu.png", name: "ProductPic" },
          {
            text: "https://products.z-wavealliance.org/products/1914/",
            id: "3134",
            name: "ZWProductPage",
            type: "4C42",
          },
          ...
          { text: "ZE26i", id: "3134", name: "Identifier", type: "4C42" },
          {
            text:
          ...
          {
            text:
              "https://Products.Z-WaveAlliance.org/ProductManual/File?folder=&filename=Manuals/1914/ZE26I Manual.pdf",
            name: "ProductManual",
          },
          {
            text:
        ...
        ChangeLog: [
          {
            Entry: [
              {
                text:
                  "Initial Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/1530/xml",
              ...
              {
                text:
                  "Updated Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/1914/xml",
                author: "Justin Hammond - Justin@dynam.ac",
                date: "24 May 2019",
                revision: 3,
              },
        ...
        Value: [
          {
            ...
            Item: [
              { label: "Full brightness (Default)", value: "0" },
