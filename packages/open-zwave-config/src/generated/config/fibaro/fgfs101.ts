    ...
    CommandClass: [
      {
        ...
        Value: [
          ...
          },
          {
            ...
            Item: [
              { label: "Signals INACTIVE", value: "0" },
              { label: "Acoustic INACTIVE, visual ACTIVE", value: "1" },
              { label: "Acoustic ACTIVE, visual INACTIVE", value: "2" },
              { label: "Acoustic ACTIVE, visual ACTIVE", value: "3" },
            ],
          },
          {
            genre: "config",
          ...
          },
          {
            ...
            Item: [
              ...
              { label: "Flood ACTIVE, tamper INACTIVE", value: "1" },
              { label: "Flood INACTIVE, tamper ACTIVE", value: "2" },
              { label: "Flood ACTIVE, tamper ACTIVE", value: "3" },
            ],
          },
          {
            genre: "config",
          ...
          },
          {
            ...
            index: "74",
            instance: "1",
            label: "Alarm frame sent to group 2 (tamper/tilt).",
            size: "1",
            type: "list",
            value: "2",
            Help:
          ...
          },
          {
            ...
            index: "76",
            instance: "1",
            label: "Alarm frame/basic set frame retransmission time",
            max: "65535",
            min: "0",
            type: "short",
            value: "0",
