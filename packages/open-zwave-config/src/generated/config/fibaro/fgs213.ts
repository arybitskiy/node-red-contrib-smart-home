    ...
    MetaData: [
      {
        MetaDataItem: [
          {
            text: "http://www.openzwave.com/device-database/010F:1000:0403",
            name: "OzwInfoPage",
          },
          { text: "images/fibaro/fgs213.png", name: "ProductPic" },
          {
            text: "https://products.z-wavealliance.org/products/2730/",
            id: "1000",
            name: "ZWProductPage",
            type: "0403",
          },
          ...
          { text: "FGS-213", id: "1000", name: "Identifier", type: "0403" },
          {
            text:
          ...
          { text: "FIBARO Single Switch 2", name: "Name" },
          {
            text:
              "https://Products.Z-WaveAlliance.org/ProductManual/File?folder=&filename=Manuals/2750/FGS-2x3-EN-T-v1.2.pdf",
            name: "ProductManual",
          },
          {
            text: "https://products.z-wavealliance.org/products/2750/",
            id: "2000",
            name: "ZWProductPage",
            type: "0403",
          },
          ...
          { text: "FGS-213", id: "2000", name: "Identifier", type: "0403" },
        ],
        ChangeLog: [
          {
            Entry: [
              {
                text:
                  "Initial Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/1734/xml",
              ...
              {
                text:
                  "Updated Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/1871/xml",
                author: "Justin Hammond - Justin@dynam.ac",
                date: "24 May 2019",
                revision: 9,
              },
              {
                text:
                  "Updated Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/2730/xml",
                author: "Justin Hammond - Justin@dynam.ac",
                date: "02 Jun 2019",
                revision: 10,
              },
              {
                text:
                  "Updated Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/2750/xml",
                author: "Justin Hammond - Justin@dynam.ac",
                date: "02 Jun 2019",
                revision: 11,
              },
      ...
      { id: "38", Compatibility: [{ GetSupported: [false] }] },
      {
        ...
        Value: [
          ...
          },
          {
            ...
            value: "0",
            Help:
              "This parameter allows to choose operating for the 2st channel controlled by the S2 switch.",
            Item: [
              { label: "Standard operation", value: "0" },
              { label: "Delay On", value: "1" },
              { label: "Delay Off", value: "2" },
