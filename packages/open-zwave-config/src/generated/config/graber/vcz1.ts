    ...
    MetaData: [
      {
        MetaDataItem: [
          {
            text: "http://www.openzwave.com/device-database/026E:5A31:5643",
            name: "OzwInfoPage",
          },
          { text: "images/graber/vcz1.png", name: "ProductPic" },
          {
            text: "https://products.z-wavealliance.org/products/1786/",
            id: "5A31",
            name: "ZWProductPage",
            type: "5643",
          },
          { text: "Virtual Cord Remote Control Z-Wave", name: "Name" },
          { text: "VCZ1", id: "5A31", name: "Identifier", type: "5643" },
          {
            text:
              "https://Products.Z-WaveAlliance.org/ProductManual/File?folder=&filename=Manuals/1786/Graber Virtual Cord Owner's Manual.pdf",
            name: "ProductManual",
          },
          {
            text:
        ...
        ChangeLog: [
          {
            Entry: [
              {
                text:
                  "Initial Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/1786/xml",
