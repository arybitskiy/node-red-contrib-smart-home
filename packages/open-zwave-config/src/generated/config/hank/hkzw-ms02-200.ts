    ...
    MetaData: [
      {
        MetaDataItem: [
          {
            text: "http://www.openzwave.com/device-database/0208:0012:0200",
            name: "OzwInfoPage",
          },
          ...
          { text: "HKZW-MS02", id: "0012", name: "Identifier", type: "0200" },
        ...
        ChangeLog: [
          {
            Entry: [
              {
                text:
                  "Initial Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/2578/xml",
