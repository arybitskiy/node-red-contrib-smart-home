    ...
    MetaData: [
      {
        MetaDataItem: [
          {
            text: "http://www.openzwave.com/device-database/0154:0101:0100",
            name: "OzwInfoPage",
          },
          { text: "images/popp/009303.png", name: "ProductPic" },
          {
            text: "https://products.z-wavealliance.org/products/2110/",
            id: "0101",
            name: "ZWProductPage",
            type: "0100",
          },
          ...
          {
            text:
              "The Wall Scene Controller is a Z-Wave device that can both control other Z-Wave devices and activate scenes. Although it is controlling other devices, the Wall Controller cannot act as Z-Wave network controller (primary or secondary) and will always need a Z-Wave network controller to be included into a Z-Wave network. The device can be used in different modes that are selected by configuration parameters:\n\nControl of groups of other Z-Wave devices using 'ON', 'OFF' and Dim commands. Activation of predefined scenes in Gateways or other Z-Wave devices. This device support secure communication when included by a controller that also supports secure communication.",
            name: "Description",
          },
          {
            text:
              "https://Products.Z-WaveAlliance.org/ProductManual/File?folder=&filename=Manuals/2110/WallSceneControllerPopp.pdf",
            name: "ProductManual",
          },
          { text: "POPE009303", id: "0101", name: "Identifier", type: "0100" },
          {
            text:
          ...
          { text: "Wall Scene Controller", name: "Name" },
        ],
        ChangeLog: [
          {
            Entry: [
              {
                text:
                  "Initial Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/2110/xml",
        ...
        Associations: [
          {
            num_groups: "5",
            Group: [
              { index: "1", label: "Life line", max_associations: "10" },
              { index: "2", label: "Group A", max_associations: "10" },
              { index: "3", label: "Group B", max_associations: "10" },
              { index: "4", label: "Group C", max_associations: "10" },
              { index: "5", label: "Group D", max_associations: "10" },
            ],
          },
        ],
      },
