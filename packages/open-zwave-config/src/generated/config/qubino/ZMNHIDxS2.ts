    ...
    MetaData: [
      {
        MetaDataItem: [
          {
            text: "http://www.openzwave.com/device-database/0159:0051:0005",
            name: "OzwInfoPage",
          },
          { text: "images/qubino/ZMNHIDx.png", name: "ProductPic" },
          { id: "0051", name: "ZWProductPage", type: "0005" },
          {
            text:
          ...
          {
            text:
              "The Qubino Flush On/Off Thermostat 2 is ideal for remotely controlling electric\n            or water-based underfloor heating systems, electric water heaters, hot water pumps, electric radiators, and\n            similar devices.",
            name: "Description",
          },
          { name: "ProductManual" },
          {
      ...
      { id: "67", Compatibility: [{ OverridePrecision: [2], Base: [0] }] },
      {
        ...
        Value: [
          ...
          },
          {
            ...
            value: "255",
            Help:
              "Flush on off thermostat module responds to commands ALL ON / ALL OFF that may be sent by the main\n                controller or by other controller belonging to the system.\n            ",
            Item: [
          ...
          },
          {
            ...
            value: "0",
            Help:
              "Set value from 0 - 100 (0% - 100%). 0 - Reporting Disabled. 1 - 100 = 1% - 100% Reporting enabled.\n                Power report is send (push) only when actual power in Watts in real time change for more than set\n                percentage comparing to previous actual power in Watts, step is 1%. Default value 0\n            ",
          },
          {
            genre: "config",
            index: "42",
          ...
          },
          {
            ...
            value: "1005",
            Help:
              "This parameter defines temperature min difference between real measured temperature and set-point\n                temperature to turn heating on.\n                The parameter can be set from 0 to 1127 where 0 to 127 means from 0.0 C to 12.7 C and from 1001 to 1127\n                means from - 0.1 C to -12.7 C.\n                Default value 132 (-0.5 C)\n            ",
          },
          {
            genre: "config",
            index: "44",
            ...
            value: "5",
            Help:
              "This parameter defines temperature min difference between real measured temperature and set-point\n                temperature to turn heating off.\n                The parameter can be set from 0 to 1127 where 0 to 127 means from 0.0 C to 12.7 C and from 1001 to 1127\n                means from - 0.1 C to -12.7 C.\n                Default value 5 (+0.5 C)\n            ",
          },
          {
            genre: "config",
            index: "45",
            ...
            value: "50",
            Help:
              "Set value means at which temperature the device will be turned on even if the thermostat was manually\n                set to off.\n                0 - 127 = 0.0C - 12.7 C.\n                1001 - 1127 = -0.1C - 12.6 C.\n                255 - Antifreeze functionality disabled.\n                Default value 50 (5.0 C).\n            ",
          },
          {
            genre: "config",
            index: "59",
            ...
            value: "0",
            Help:
              "\n                This parameter determines how the device will operate if it will operate in the heating mode or in the\n                cooling mode.\n                The range of the hysteresis will remain the same, only operation will change from heating to cooling and\n                vice versa\n            ",
            Item: [
              { label: "Heat", value: "0" },
              { label: "Cool", value: "1" },
            ],
          },
          {
            ...
            value: "50",
            Help:
              "\n                Default value 50 (Minimum Temperature alarm is 5.0C)\n                1 - 1000 = 0.1C - 100.0C, step is 0.1C.\n                1001 - 1150 = -0.1 C - 15 C\n                Too low temperature limit is set by entered value. In case is set value out of this range, module is\n                changing set value automatically to default value.\n            ",
          },
          {
            genre: "config",
            index: "61",
            ...
            value: "700",
            Help:
              "\n                Default value 700 (Minimum Temperature alarm is 70.0C)\n                1 - 1000 = 0.1C - 100.0C, step is 0.1C.\n                Too high temperature limit is set by entered value. In case is set value out of this range, module is\n                changing automatically set value to default value.\n            ",
          },
          {
            genre: "config",
            index: "63",
          ...
          },
          {
            ...
            value: "0",
            Help:
              "\n                Default value 0\n                1 - 32000 seconds\n                If the value of the parameter is different to 0, means that the influence of this input to heating or\n                cooling will react after inserted time.\n                This parameter has influence only when the window sensor functionality is selected by the parameter no.\n                11.\n            ",
          },
          {
            genre: "config",
            index: "71",
          ...
          },
          {
            ...
            value: "0",
            Help:
              "\n                Default value 0\n                1 - 32000 seconds\n                If the value of the parameter is different to 0, means that the influence of this input to heating or\n                cooling will react after inserted time.\n                This parameter has influence only when the condense sensor functionality is selected by the parameter\n                no. 12.\n            ",
          },
          {
            genre: "config",
            index: "73",
          ...
          },
          {
            ...
            value: "0",
            Help:
              "\n                Default value 0\n                1 - 32000 seconds\n                If the value of the parameter is different to 0, means that the influence of this input to heating or\n                cooling will react after inserted time.\n                This parameter has influence only when the flood sensor functionality is selected by the parameter no.\n                13.\n            ",
          },
          {
            genre: "config",
            index: "75",
          ...
          },
          {
            ...
            value: "5",
            Help:
              "If digital temperature sensor is connected, module reports measured temperature on temperature change\n                defined by this parameter.\n                0 = reporting disabled.\n                1 to 127 = 0,1C to 12,7C, step is 0,1C.\n                Default value is 5 = 0,5C\n            ",
          },
          {
            genre: "config",
            index: "121",
            ...
            value: "0",
            Help:
              "\n                If digital temperature sensor is not connected, module can grab measured temperature from external\n                secondary module.\n                Default value is 0.\n            ",
            Item: [
              {
                label:
