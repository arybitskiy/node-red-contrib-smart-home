    ...
    MetaData: [
      {
        MetaDataItem: [
          {
            text: "http://www.openzwave.com/device-database/003B:0468:0001",
            name: "OzwInfoPage",
          },
          { text: "images/schlage/BE468ZP.png", name: "ProductPic" },
          {
            text: "https://products.z-wavealliance.org/products/3028/",
            id: "0468",
            name: "ZWProductPage",
            type: "0001",
          },
          ...
          { text: "BE468ZP", id: "0468", name: "Identifier", type: "0001" },
          {
            text:
              "https://Products.Z-WaveAlliance.org/ProductManual/File?folder=&filename=Manuals/3028/Connect_QSG_Add_Remove_FDR_Association.pdf",
            name: "ProductManual",
          },
          {
            text:
        ...
        ChangeLog: [
          {
            Entry: [
              {
                text:
                  "Initial Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/3028/xml",
