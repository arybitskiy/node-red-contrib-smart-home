    ...
    MetaData: [
      {
        MetaDataItem: [
          {
            text: "http://www.openzwave.com/device-database/008B:5431:5452",
            name: "OzwInfoPage",
          },
          { text: "images/trane/TZEMT400AB32MAA.png", name: "ProductPic" },
          {
            text: "https://products.z-wavealliance.org/products/109/",
            id: "5431",
            name: "ZWProductPage",
            type: "5452",
          },
          ...
          { text: "T400A", id: "5431", name: "Identifier", type: "5452" },
        ],
        ChangeLog: [
          {
            Entry: [
              {
                text:
                  "Initial Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/109/xml",
