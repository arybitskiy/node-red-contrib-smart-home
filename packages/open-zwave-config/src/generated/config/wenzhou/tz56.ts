    ...
    MetaData: [
      {
        MetaDataItem: [
          {
            text: "http://www.openzwave.com/device-database/0118:0003:0003",
            name: "OzwInfoPage",
          },
          { text: "images/wenzhou/tz56.png", name: "ProductPic" },
          {
            text: "https://products.z-wavealliance.org/products/1586/",
            id: "0003",
            name: "ZWProductPage",
            type: "0003",
          },
          ...
          { text: "TZ68F", id: "0003", name: "Identifier", type: "0003" },
          {
            text:
              "https://Products.Z-WaveAlliance.org/ProductManual/File?folder=&filename=Manuals/1586/TZ68 User Manual.pdf",
            name: "ProductManual",
          },
          {
            text:
        ...
        ChangeLog: [
          {
            Entry: [
              {
                text:
                  "Initial Metadata Import from Z-Wave Alliance Database - https://products.z-wavealliance.org/products/1586/xml",
        ...
        Value: [
          {
            ...
            value: "1",
            Help:
              "The LED on the TZ56D will by default, turn ON when the load attached is turned OFF. To make the LED turn ON when the load attached is turned ON instead, set parameter to a value of 1.",
          },
          {
            genre: "config",
            index: "2",
          ...
          },
          {
            ...
            value: "0",
            Help:
              "Setting this parameter to the value of 1 will stop the TZ56D from transmitting to devices that are associated into Group 4.",
          },
        ],
      },
    ],
